import { Code, Database, Cloud, Wrench, Smartphone, Brain, Bot, Layout, Server, Zap } from "lucide-react";
export const skills = [
  // Frontend
...
export const services = [
  {
    ...
    description: "End-to-end web applications built with MERN (MongoDB, Express, React, Node.js) and PERN (PostgreSQL) stacks. Specializing in highly scalable SaaS platforms and feature-rich administrative dashboards.",
    icon: Layout,
    tags: ["React", "Node.js", "PostgreSQL", "MongoDB"]
  },
  {
    id: 2,
    title: "Next.js & FastAPI Solutions",
    description: "High-performance websites and ultra-fast APIs. Leveraging Next.js for superior SSR/SSG and FastAPI for high-concurrency backend services with comprehensive OpenAPI documentation.",
    icon: Server,
  ...
  },
  {
    ...
    description: "Cross-platform mobile applications using React Native and Expo. Focused on offline-first architectures, real-time synchronization, and native-like performance for iOS and Android.",
    icon: Smartphone,
    tags: ["React Native", "Expo", "Mobile UI", "FCM"]
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "Revitalizing slow applications. Optimizing complex SQL/NoSQL queries, implementing caching strategies with Redis, and fine-tuning frontend performance for 90+ Lighthouse scores.",
    icon: Zap,
    tags: ["Redis", "Optimization", "SQL Tuning", "Performance"]
  }
];
